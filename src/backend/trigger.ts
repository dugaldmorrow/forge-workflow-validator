...
export const onIssueChanged = async (event: any, context: any) => {
  ...
  // *** With the change to always pulling data from the database dynamically on-demand, this function is no longer
  // *** called (the reference is commented out in the app manifest).
